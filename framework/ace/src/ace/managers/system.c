...
__attribute__((section("text"))) static const UWORD s_pGetVbrCode[] = {0x4e7a, 0x0801, 0x4e73};

// Get cache control register contents (020+).
// Instructions: movec cacr,d0; rte
__attribute__((section("text"))) static const UWORD s_pGetCacr[] = {0x4e7a, 0x0002, 0x4e73};

// Get processor configuration register contents (060+).
// Instructions: movec pcr,d0; rte
__attribute__((section("text"))) static const UWORD s_pGetPcr[] = {0x4e7a, 0x0801, 0x4e73};

// Move d0 into the cache control register
// movec d0,cacr; rte
__attribute__((section("text"))) static const UWORD s_pSetCacr[] = {0x4e7b, 0x0002, 0x4e73};

// Move d0 into the cache control register and flush caches
// movec d0,cacr; cpusha ic+dc; rte
__attribute__((section("text"))) static const UWORD s_pSetCacr040[] = {0x4e7b, 0x0002, 0xf4f8, 0x4e73};

// Move d0 into the processor configuration register
__attribute__((section("text"))) static const UWORD s_pSetPcr[] = {0x4e7b, 0x801, 0x4e73};
...
static UWORD s_uwOsVectorInts = (INTF_TBE | INTF_DSKBLK | INTF_SOFTINT |
...
static void systemOsDisable(void)
{
	...
	g_pCia[CIA_A]->icr = (CIAICRF_SETCLR | CIAICRF_SERIAL | CIAICRF_TIMER_A | CIAICRF_TIMER_B);
	g_pCia[CIA_B]->icr = (CIAICRF_SETCLR | CIAICRF_SERIAL | CIAICRF_TIMER_A | CIAICRF_TIMER_B);
